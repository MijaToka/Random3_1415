...
def numeroATexto(n):
    ...
    if um == 1:
        cortePalabras = resultado.find(" mil ") # Encuentrame el indice donde aparece " mil "
        resultado = resultado.pop(cortePalabras - 4 , cortePalabras)
        print(cortePalabras)

    return resultado


print(numeroATexto(1100))    #TODO: ARREGLAR ESTO CON LOS UNO MILLONES Y EL UNO MIL
